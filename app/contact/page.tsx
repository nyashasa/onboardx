      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            Have questions about OnboardX? We're here to help you streamline 
            your client onboarding process and improve your team's efficiency.
          </p>
          <div className="space-y-4 mt-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">support@onboardx.com</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="bg-primary/10 p-3 rounded-full mr-4">
